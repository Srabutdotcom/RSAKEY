...
const rsaPemKey = Deno.readTextFileSync(new URL('../../samplersakey/key.pem', baseUrl));

//const asn1Key = new RSAKey(pemKey, {sha:256, saltLength:0});
const asn1RsaKey = new RSAKey(rsaPemKey, {sha:256, saltLength:0}); 

const msg = new Uint8Array([1, 4, 5, 6]);

//const sign = asn1Key.RSASSA_PSS_SIGN(msg);
const sign = asn1RsaKey.RSASSA_PSS_SIGN(msg);
...
const verify = asn1RsaKey.RSASSA_PSS_VERIFY({n:asn1RsaKey.n, e:asn1RsaKey.e},msg, sign);debugger;